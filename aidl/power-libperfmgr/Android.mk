...
LOCAL_MODULE := android.hardware.power-service.moto-libperfmgr
LOCAL_INIT_RC := android.hardware.power-service.moto-libperfmgr.rc
LOCAL_MODULE_TAGS := optional
LOCAL_VENDOR_MODULE := true
LOCAL_VINTF_FRAGMENTS := android.hardware.power-service.moto.xml
